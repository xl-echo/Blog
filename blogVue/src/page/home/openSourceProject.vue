      ...
      <Row>
        <Col style="margin-top: 10px;margin-bottom: 10px" align="center" span="4" v-for="i in item" :key="i.id">
          <Card align="center" style="width: 85%;height: 85%;">
            <Row>
              <Col>
                <p style="font-size: 20px">{{i.projectName}}</p>
              </Col>
            </Row>
            <Row>
            ...
            <Row>
              <Col style="margin-top: 10px">
                HTTPS:&nbsp;<Input v-model="i.https" style="width: 70%" />
              </Col>
            </Row>
            <Row>
              <Col style="margin-top: 10px">
                SSH:&nbsp;<Input v-model="i.ssh" style="width: 80%" />
              </Col>
            </Row>
            <Row>
              <Col style="margin-top: 10px">
                <Button type="primary" @click="projectDetail(i)" long>进入项目</Button>
              </Col>
            </Row>
          </Card>
        </Col>
